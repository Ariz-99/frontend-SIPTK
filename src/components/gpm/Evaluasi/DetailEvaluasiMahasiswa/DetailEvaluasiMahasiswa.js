...
import './DetailEvaluasiMahasiswa.css'


function DetailEvaluasiMahasiswa({ mahasiswaId }) {
    ...
    const handleBack = () => {
        navigate('/gpm/evaluasi'); // Mengarahkan ke path '/dosen/perwalian'
    };
...
export default DetailEvaluasiMahasiswa;